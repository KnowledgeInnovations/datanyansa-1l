...
const sections: Section[] = [
  {
    ...
    blocks: [
      {
        type: "p",
        text: "Depending on how you interact with Data Nyansa, we may collect:",
      },
      {
        type: "list",
        items: [
  ...
  },
  {
    ...
    blocks: [
      {
        type: "p",
        text: "Data Nyansa undertakes research involving individuals, organisations and communities.",
      },
      {
        type: "p",
  ...
  },
  {
    ...
    blocks: [
      {
        type: "p",
        text: "Data Nyansa does not sell or rent personal information.",
      },
      {
        type: "p",
  ...
  },
  {
    ...
    blocks: [
      ...
      {
        type: "p",
        text: "Subject to the Act and applicable circumstances, you may have the right to:",
      },
      {
        type: "list",
        items: [
  ...
  },
  {
    ...
    blocks: [
      {
        type: "p",
        text: "Our website may contain links to third-party websites, platforms and services.",
      },
      {
        type: "p",
...
const introParagraphs = [
  <span key="intro-1">
    Data Nyansa ("Data Nyansa", "we", "us" or "our") is committed to protecting
    the privacy and personal information of individuals who interact with our
    website, services, research activities, training programmes, events and
    other activities.
  </span>,

  <span key="intro-2">
    This Privacy Statement explains how Data Nyansa collects, uses, stores,
    protects and discloses personal information in accordance with the Data
    Protection Act, 2012 (Act 843) of the Republic of Ghana and applicable
    guidance of the{" "}
    <a
    ...
    >
      Data Protection Commission of Ghana (DPC)
    </a>
    .
  </span>,

  <span key="intro-3">
    The Data Protection Act establishes principles governing the collection,
    use, disclosure, security and handling of personal data in Ghana.
  </span>,
];
      ...
      <main>
        ...
        <section className="relative overflow-hidden border-b border-border bg-primary py-20 text-primary-foreground lg:py-28">
          ...
          <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <p className="mb-5 text-sm font-semibold uppercase tracking-[0.22em] text-primary-foreground/70">
              Privacy
            </p>
            ...
            <p className="mt-7 max-w-3xl text-lg leading-8 text-primary-foreground/80">
              Data Nyansa is committed to protecting the privacy and personal
              information of individuals who interact with our website,
              services, research activities, training programmes, events and
              other activities.
            </p>
          ...
          <div className="grid gap-12 lg:grid-cols-[16rem_1fr] lg:gap-16">
            ...
            >
              <div className="rounded-2xl border border-border bg-card p-6">
                <h2
                  id="toc-heading"
                  className="text-sm font-semibold uppercase tracking-[0.16em] text-foreground/60"
                >
                  On this page
                </h2>
                <ul className="mt-5 flex flex-col gap-1">
                  {sections.map((section) => (
                    <li key={section.id}>
                      ...
                      >
                        <span className="font-mono text-xs leading-6 text-primary/70">
                          {section.number}
                        </span>
              ...
              <div className="rounded-2xl border border-border bg-card p-6 sm:p-9">
                <div className="flex flex-col gap-5">
                  {introParagraphs.map((paragraph) => (
                    <p
                      key={paragraph.key}
                      className="text-base leading-8 text-foreground/75 sm:text-lg"
                    >
                      {paragraph}
                    </p>
                  ))}
              ...
              <div className="mt-14 flex flex-col gap-14">
                    ...
                    <div className="mt-7 flex flex-col gap-6">
                      {section.blocks.map((block, index) =>
                        block.type === "p" ? (
                          <p
                            key={index}
                            className="max-w-3xl text-base leading-8 text-foreground/70"
                          >
                            {block.text}
                          </p>
                        ) : (
                          ...
                          >
                            {block.items.map((item) => (
                              <li
                                key={item}
                                className="flex gap-3 text-base leading-8 text-foreground/70"
                              >
                                <span
                                  aria-hidden="true"
                ...
                >
                  ...
                  <p className="mt-7 max-w-3xl text-base leading-8 text-foreground/70">
                    ...
                    Privacy Statement or the way Data Nyansa handles personal
